...
O sistema permite operações completas de **CRUD**:
...
Este projeto representa a transição de um modelo tradicional e manual para uma **infraestrutura moderna baseada em containers**, utilizando **Docker** e **Docker Compose**.
...
- **Docker Compose** habilitado no terminal
...
3. O sistema aguardará o **banco de dados estar saudável** antes de iniciar a aplicação.

4. Após iniciar, acesse no navegador:
